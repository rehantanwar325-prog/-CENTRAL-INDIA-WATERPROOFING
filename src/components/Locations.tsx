...
const locations = [
  { 
    city: 'Nagpur',
    img: 'https://images.unsplash.com/photo-1559825484-357f5b5578e6?auto=format&fit=crop&w=600&q=80', 
    state: 'Maharashtra', 
    type: 'Head Office',
    ...
    >
      ...
      <div className="container-custom relative">
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
          <span className="inline-block px-4 py-1.5 rounded-full bg-emerald-100 text-emerald-700 text-sm font-semibold mb-6">Our Locations</span>
          <h2 id="locations-heading" className="section-title">
            Visit Our <span className="gradient-text">Offices</span>
          </h2>
          <p className="section-subtitle">
            Head office in Nagpur with branches across Central India. Visit us or call for a free inspection.
          </p>
        </div>
              ...
              <div className="relative z-10">
                <div className="relative -mx-6 -mt-6 sm:-mx-8 sm:-mt-8 mb-5 overflow-hidden rounded-t-2xl h-36">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        parent.classList.add('flex', 'items-center', 'justify-center', `bg-gradient-to-br`, location.gradient)
                ...
                {location.phone && (
                  <div className="mb-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100">
                    <a href={`tel:+91${location.phone.replace(/[\s,]/g, '')}`} className="flex items-center gap-3 text-sm font-semibold text-green-700 hover:text-green-800 transition-colors">
