      ...
      <div className="container-custom relative">
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
          ...
          <h2 id="contact-heading" className="section-title">
            Get Your Free Site <span className="gradient-text">Inspection</span> Today
          </h2>
          <p className="section-subtitle">
            Have a leak or planning waterproofing in Nagpur, Akola or Chandrapur? Contact India&apos;s most trusted waterproofing experts. 
