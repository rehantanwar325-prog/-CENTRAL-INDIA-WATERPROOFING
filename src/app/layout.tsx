...
export const metadata: Metadata = {
  title: {
    default: 'Best Waterproofing Company in Nagpur, Maharashtra | Central India Waterproofing',
    template: '%s | Central India Waterproofing',
  },
  description: 'Central India Waterproofing is Maharashtra\'s #1 rated roof waterproofing company serving Nagpur, Akola & Chandrapur. Expert SEALROOF CETROOF treatment, terrace waterproofing, spray coating & membrane sheet waterproofing with warranty. Call +91 89751 38745 for free inspection.',
  keywords: [
    'waterproofing company Nagpur',
    'best waterproofing company Maharashtra',
    ...
    'roof waterproofing Maharashtra',
    'best roof waterproofing company India',
    'waterproofing company Central India',
    ...
    'industrial roof waterproofing Maharashtra',
    ...
    'waterproofing solution Maharashtra',
    'best waterproofing in Vidarbha',
    'Vidarbha waterproofing company',
  ],
  ...
  openGraph: {
    title: 'Best Waterproofing Company in Nagpur, Akola & Chandrapur | Central India Waterproofing',
    description: 'Maharashtra\'s #1 rated roof waterproofing experts. SEALROOF CETROOF treatment, terrace waterproofing, spray coating with warranty. Serving Nagpur, Akola & Chandrapur. Free inspection. Call +91 89751 38745.',
    type: 'website',
    locale: 'en_IN',
  ...
  twitter: {
    ...
    title: 'Best Waterproofing Company in Nagpur, Maharashtra | Central India Waterproofing',
    description: 'Maharashtra\'s #1 rated roof waterproofing experts. SEALROOF CETROOF treatment, terrace waterproofing with warranty. Nagpur, Akola & Chandrapur. Call +91 89751 38745.',
  },
  robots: {
    index: true,
    follow: true,
    ...
    '@graph': [
      {
        ...
        description: 'Maharashtra\'s #1 rated roof waterproofing company. Expert SEALROOF CETROOF treatment, terrace waterproofing, spray coating & membrane sheet waterproofing. Serving Nagpur, Akola & Chandrapur with 25+ years experience.',
        url: 'https://centralindiawaterproofing.com',
      ...
      // Branch - Akola
      {
        ...
        description: 'Best waterproofing company in Akola, Maharashtra. Roof waterproofing, SEALROOF CETROOF treatment & terrace waterproofing services.',
      ...
      // Branch - Chandrapur
      {
        ...
        description: 'Best waterproofing company in Chandrapur, Maharashtra. Roof waterproofing, SEALROOF CETROOF treatment & terrace waterproofing services.',
      ...
      // FAQPage for rich snippets
      {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: 'What is the best waterproofing company in Nagpur?',
            acceptedAnswer: { '@type': 'Answer', text: 'Central India Waterproofing is rated the best waterproofing company in Nagpur with 25+ years of experience, 5000+ satisfied clients, and a 4.9/5 rating. We specialize in SEALROOF CETROOF treatment and roof waterproofing.' },
          },
          {
            '@type': 'Question',
