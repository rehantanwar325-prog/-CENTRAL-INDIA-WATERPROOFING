    ...
    '@graph': [
      {
        ...
        hasOfferCatalog: {
          ...
          itemListElement: [
            ...
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Basement & Foundation Waterproofing', description: 'Professional basement and foundation waterproofing services.' } },
          ],
        },
        sameAs: [],
      },
      ...
      // FAQPage for rich snippets
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'We offer SEALROOF CETROOF Treatment, Roof & Terrace Waterproofing, Bathroom & Wet Area Waterproofing, Roller Applied Roof Coating, Wall Seepage & Dampness Treatment, and Basement & Foundation Waterproofing across Nagpur, Akola, and Chandrapur.' },
          },
          {
            '@type': 'Question',
